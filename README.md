...
> 💡 **Визуальная ER-диаграмма**: См. файлы `ER_DIAGRAM.md`, `ER_DIAGRAM_VISUAL.md` и `database_diagram.xml`
...
### Связи
- **Users → Events** (1:N): Один пользователь организует много мероприятий
- **Events ↔ Users** (N:M): Мероприятия и участники (через `events_participants`)
...
- **README.md** - основная инструкция (этот файл)
- **API_DOCUMENTATION.md** - детальное описание всех API endpoints
- **EXAMPLES.md** - примеры HTTP-запросов (cURL, PowerShell, HTTPie)
- **DEPLOYMENT.md** - руководство по развертыванию
- **ARCHITECTURE.md** - архитектурные решения и обоснования
- **TEST_DATA.md** - инструкции по тестированию
- **ER_DIAGRAM.md** - ER-диаграмма в Mermaid формате
- **ER_DIAGRAM_VISUAL.md** - визуальная ASCII-диаграмма
- **DB_DESIGNER_GUIDE.md** - руководство по работе с ER-диаграммами
- **database_schema.sql** - SQL-скрипт создания БД
- **database_diagram.xml** - ER-диаграмма для импорта в редакторы
